...
public class UserTask extends User{
    ...
    public UserTask(String userName, String email, String password, ArrayList<Task> tasks, ArrayList<Projeto> projects) {
    ...
    public ArrayList<Projeto> getProjects() { return projects; }
    public void setProjects(ArrayList<Projeto> projects) { this.projects = projects; }

    public void addTask(Task newTask) {
        Task checker = getTaskById(newTask.getTaskId());
